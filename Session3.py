...
# They hold the hashcode for the data
...
# Kia would liek to unfollow
# del followers[4] #Error

# Tuple as a Multi Value Container is IMMUTABLE
# Once it is created it gets ficed and we cannot change it
# i.e. add, update and delete operations won't work.