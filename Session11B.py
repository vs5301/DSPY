class Shoe:
    ...
    def show_shoe_details(self):
        print("=============================")
        print("{}\n{}\n{} {}\n{} {}".format(self.name, self.brand_name, self.price,
                                            (self.price-self.price*self.discount), self.color, self.sizes))
        print("=============================")
...
shoe1 = Shoe("Skateboarding", "Adidas Originals", 5999, 0.25, "black", [5, 6, 7, 9])  # init will be executed
...
shoe2 = Shoe("AlphaBounce", "Adidas Originals", 8999, 0.40, "white", [5, 6, 7, 8, 10])
# init will be executed automatically for us
...
print(">> {} is available at {} price".format(shoe1.name, shoe1.get_discounted_price()))
print(">> {} is available at {} price".format(shoe2.name, shoe2.get_discounted_price()))
