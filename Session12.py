"""
    ...
    1 Restaurant Has 1 Menu | one to 1
    1 Menu Has Many Dishes | one to *
...
restaurant_dictionary = {
        ...
        "menu": {
            "name": "Pure Veg",
            "dishes": [
                {"name": "Plain Channa Bhatura",
                 "description": "Exotic Flavour From Delhi",
                 "price": 170, "discount": 0.5},
                {"name": "Paneer Channa Bhatura", "description": "Exotic Flavour From Delhi", "price": 240,
                 "discount": 0.5},
                {"name": "Lassi", "description": "Exotic Flavour From Delhi", "price": 80,
                 "discount": 0.4},
